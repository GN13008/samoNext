...
function InfoCardComponent({
  ...
  return (
    <div className="card bg-base-100 shadow-xl rounded-box px-8 py-4 flex-cols gap-2">
      {svg}
...
export default function Home() {
  return (
    <main className="flex min-h-screen flex-col items-center">
      ...
      >
        ...
        <div className="hero-content text-neutral-content text-center">
          <div className="max-w-md">
            ...
            <p className="mb-5">Votre revendeur d'acier au détails</p>
      ...
      <div className="hero bg-base-200">
        <div className="hero-content flex-col lg:flex-row">
          ...
          <div>
            ...
            <p className="py-6">
              Chez SAMO Aciers, nous vendons de l'acier depuis 1991, blabla
              historique
            </p>
          </div>
        </div>
      ...
      <div className="container grid grid-cols-3 gap-4 w-full p-4">
        <InfoCardComponent
          svg={
            <svg
          ...
          title="Livraison"
          content="Livraison dans toute la france"
        />
        <InfoCardComponent
          svg={
            <svg
          ...
          title="Paiement"
          content="Fonctionnalité d'achat en ligne pas encore disponible, merci de nous
            contacter"
        />
        <InfoCardComponent
          svg={
