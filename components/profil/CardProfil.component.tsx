...
const CardProfil = () => {
  return (
    <div className="card glass-card bg-base-200 w-100 lg:w-96 mx-8 mt-8 lg:mb-8">
      <div className="card-body">
        <section className="shrink-0">
          <div className="flex items-start justify-start gap-4 lg:flex-col lg:gap-8">
            <div className="flex lg:w-full justify-between">
              ...
              <div className="mt-4 hidden lg:flex flex-col gap-4">
                <button className="btn btn-primary btn-sm btn-square lg:text-lg">
                  <svg
            ...
            <div className="flex-1">
              {/* DATA */}
              <h1 className="mb-1 text-xl font-bold lg:mb-3 lg:text-4xl lg:font-extrabold">
                Enzo Perez
              </h1>
              <div className="flex flex-col gap-2 lg:flex-row lg:gap-4">
                <h2 className="flex items-center gap-1">
                  ...
                  <span className="text-base-content">Marseille</span>
                </h2>
                <h2 className="flex items-center gap-1">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                  ...
                  <span className="text-base-content">Kitefoil Race</span>
                </h2>
              </div>
            </div>
          ...
          <p className="text-gray-100 my-4">
            <span className="font-bold">Moniteur kitesurf</span> -
            <span className="text-primary"> Almanarre</span>
          </p>
          <p className="lg:mb-8">
            Moniteur, sprotif haut niveau, des projets plein la tête
          </p>
          <div className="hidden lg:block">
            <div className="divider divider-primary">Réseaux</div>
          </div>
