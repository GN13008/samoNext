  ...
  return (
    <>
      <div className="w-full mb-4 lg:mb-8">
        <h2 className="mb-4 w-full text-left">Un service fiabilisé</h2>
      ...
      <div className="space-y-8 md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-12 md:space-y-0">
        <div>
          ...
          <p className="text-gray-500">
            En tant qu’entreprise familiale, nous mettons un point d’honneur à
            établir des relations solides avec nos clients, fondées sur la
        ...
        <div>
          ...
          <p className="text-gray-500">
            Grâce à notre stock et à notre capacité de sciage, notre entreprise
            de taille humaine nous permet de garantir des délais de livraison
            rapides pour répondre aux besoins urgents de nos clients.
          </p>
        </div>
        <div>
          <div className="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-blue-100 lg:h-12 lg:w-12">
